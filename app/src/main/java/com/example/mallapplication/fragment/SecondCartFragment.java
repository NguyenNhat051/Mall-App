...
import static com.example.mallapplication.fragment.ThirdCartFragment.orderType;
...
public class SecondCartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.second_fragment_cart, container, false);
    ...
    private double calculateTotalPrice(ArrayList<GroceryItem> cartItems) {
        double price = 0;
