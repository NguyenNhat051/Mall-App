...
import static com.example.mallapplication.fragment.SecondCartFragment.ORDER_KEY;
...
public class ThirdCartFragment extends Fragment {
    ...
    public static final Type orderType = new TypeToken<Order>() {
    }.getType(); //Convert Order from json

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.third_fragment_cart, container, false);
            ...
            if (null != jsonOrder) {
                ...
                btnCheckout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        order.setSuccess(true); //For testing
